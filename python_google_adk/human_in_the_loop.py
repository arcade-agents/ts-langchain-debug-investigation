...
ENFORCE_HUMAN_CONFIRMATION = ['PagerdutyApi_UpdateIncidentStatus', 'PagerdutyApi_AddIncidentNote', 'Slack_SendDmToUser', 'Slack_SendMessageToChannel', 'Gmail_SendEmail', 'GoogleCalendar_CreateEvent']
